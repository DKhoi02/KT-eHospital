...
@Component({
  selector: 'app-addmin-profile',
  templateUrl: './addmin-profile.component.html',
  styleUrls: ['./addmin-profile.component.css'],
})
export class AddminProfileComponent implements OnInit {
