...
@Component({
  selector: 'app-doctor-medical-examination',
  templateUrl: './doctor-medical-examination.component.html',
  styleUrls: ['./doctor-medical-examination.component.css'],
})
export class DoctorMedicalExaminationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.appointmentService
      .getAllMedicalByDoctor(this.currentUser)
      .subscribe((res) => {
        this.lstData = res;
